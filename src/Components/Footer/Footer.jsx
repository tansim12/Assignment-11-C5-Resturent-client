            ...
            <div>
              <ul className="flex flex-wrap items-center gap-y-2 gap-x-8 justify-center">
                ...
                <li>
                  <NavLink
                    to={"/"}
                    className="block font-sans text-base  leading-relaxed text-blue-gray-900 antialiased transition-colors hover:text-neutral focus:text-neutral"
                  >
                    Home
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    to={"/blog"}
                    className="block font-sans text-base font-normal leading-relaxed text-blue-gray-900 antialiased transition-colors hover:text-neutral focus:text-neutral"
                  >
                    Blogs
                  </NavLink>
                </li>
